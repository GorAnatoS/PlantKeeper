...
class SelectPlantImageUriFromCollectionDialogFragment(val viewModel: PlantDetailViewModel) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myList: List<Uri> = listOf(
            ...
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_plant4"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_plant5"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_plant6"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_plant7"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_plant8"),

            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower1"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower2"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower3"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower4"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower5"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower6"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower7"),
            Uri.parse("android.resource://com.goranatos.plantkeeper/drawable/ic_flower8"),
        )
